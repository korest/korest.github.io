...
date = 2018-11-06
draft = false
slug = "serverless-in-action-part-2"
description = "Building CRUD operations with AWS Lambda and Kotlin"
tags = ["serverless", "kotlin", "aws", "lambda"]
author = "Orest Kyrylchuk"
+++

> [Part 0: Intro](/articles/serverless-in-action-part-0/) and [Part 1: Auth](/articles/serverless-in-action-part-1/)

## Introduction

This section is about the core of our application - CRUD lambda functions. To remind you of the architecture:
![](/images/serverless-in-action/crud.jpg)
...
![](/images/serverless-in-action/crud_deploy.jpg)
