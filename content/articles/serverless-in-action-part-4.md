...
date = 2019-03-03
draft = false
slug = "serverless-in-action-part-4"
description = "Building CI/CD pipeline with AWS CodeBuild and CodePipeline"
tags = ["serverless", "aws", "codebuild", "codepipeline", "lambda"]
author = "Orest Kyrylchuk"
+++

> [Part 0: Intro](/articles/serverless-in-action-part-0/), [Part 1: Auth](/articles/serverless-in-action-part-1/) and [Part 2: CRUD](/articles/serverless-in-action-part-2/) and [Part 3: Notification](/articles/serverless-in-action-part-3/)
...
* [Auth](/articles/serverless-in-action-part-1/) - Authentication, Authorization and Registration.
* [CRUD](/articles/serverless-in-action-part-2/) - Waitlist and Waitee.
* [Notification](/articles/serverless-in-action-part-3/) - Producer and Consumer.
...
![](/images/serverless-in-action/code_pipeline.jpg)
...
![](/images/serverless-in-action/code_pipeline_final.jpg)
