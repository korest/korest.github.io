...
draft = false
slug = "serverless-in-action-part-1"
description = "Building authentication and authorization with AWS Lambda and Go"
tags = ["serverless", "go", "aws", "lambda"]
author = "Orest Kyrylchuk"
+++

> Part 0: Intro could be found [here](/articles/serverless-in-action-part-0/).
...
![](/images/serverless-in-action/auth.jpg)
...
![](/images/serverless-in-action/auth_deploy.jpg)
...
![](/images/serverless-in-action/auth_register.jpg)
...
![](/images/serverless-in-action/auth_token.jpg)
...
What's next?
* [Part 2: CRUD](/articles/serverless-in-action-part-2/)
* [Part 3: Notifications](/articles/serverless-in-action-part-3/)
