...
date = 2018-11-17
draft = false
slug = "serverless-in-action-part-3"
description = "Building notification system with AWS Lambda, SQS, and TypeScript"
tags = ["serverless", "typescript", "nodejs", "aws", "lambda"]
author = "Orest Kyrylchuk"
+++

> [Part 0: Intro](/articles/serverless-in-action-part-0/), [Part 1: Auth](/articles/serverless-in-action-part-1/) and [Part 2: CRUD](/articles/serverless-in-action-part-2/)
...
![](/images/serverless-in-action/notification.jpg)
...
![](/images/serverless-in-action/notification_deploy.jpg)
